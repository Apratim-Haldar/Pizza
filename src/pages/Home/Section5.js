        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>save up to 20%</h2>
              <p>
                Experience convenience at your fingertips! Order your favorite pizzas, explore exclusive deals, and enjoy savings of up to 20% with our easy-to-use mobile app. Don’t miss out!
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
